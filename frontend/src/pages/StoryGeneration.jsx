...
const StoryGeneration = () => {
  ...
  const handleOnChange = () => {
    ...
    dispatch(setGenerationOptions(formData));
  };
        ...
        <div className="w-full flex justify-center items-center text-4xl text-center flex-col lg:text-[64px] lg:leading-[58px] font-bold mb-10">
          <div className="w-full  mb-8">
            ...
            <p className=" text-xl lg:text-[28px] leading-8 text-[#6B6D6E] lg:w-[80%] raleway-medium py-4 mx-auto">
              ...
              theme. (e.g., 'Write a story about a mysterious island' or 'Create
              a romantic tale set in Paris')
            </p>
          </div>
        </div>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        {...field}
                        type="number"
                        className="block w-full px-4 py-3 h-[50px] rounded-[40px] raleway-semibold text-xl custom-number-input"
                        min="1"
                        max="7"
                        onChange={(e) => {
